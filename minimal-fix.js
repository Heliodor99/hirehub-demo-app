...
const backupPath = `${candidatesPath}.backup-simple-${Date.now()}`;

// Create backup
fs.copyFileSync(candidatesPath, backupPath);
console.log(`Created backup at ${backupPath}`);

// Create a properly formatted file from scratch
...
console.log(`Created a new simplified candidates file at ${candidatesPath}`);
...
fs.writeFileSync('restore-candidates-simple.js', restoreScriptContent);
console.log('Created a restore script at restore-candidates-simple.js'); 